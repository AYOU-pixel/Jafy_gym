    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {/* ── Section header ─────────────────────────────── */}
          <div className="mb-14 flex flex-col gap-8 sm:mb-16 sm:flex-row sm:items-end sm:justify-between lg:mb-20">
            ...
            {/* Program index — desktop only, purely decorative */}
            <div className="hidden items-end gap-8 sm:flex lg:pb-1">
              {programs.map((p) => (
                ...
                >
                  <span
                    className="text-[9px] font-medium uppercase tracking-[0.2em] transition-colors duration-300 group-hover:text-white/30"
                    style={{ color: "rgba(255,255,255,0.10)" }}
                  >
                    {p.number}
                  </span>
                  <span
                    className="block h-[1px] w-6 transition-all duration-300 group-hover:w-8 group-hover:opacity-30"
                    style={{ background: "rgba(255,255,255,0.08)" }}
                  />
                  <span
                    className="whitespace-nowrap text-[9px] font-medium tracking-wide transition-colors duration-300 group-hover:text-white/30"
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
            ...
            <article
              ...
              className="group relative cursor-pointer overflow-hidden rounded-2xl md:col-span-2 lg:col-span-3"
              style={{
                minHeight: "clamp(400px, 50vw, 580px)",
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, #050505 0%, rgba(5,5,5,0.48) 48%, rgba(5,5,5,0.04) 100%)",
                }}
              />
              {/* Subtle purple edge */}
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at 0% 0%, rgba(144,0,232,0.07) 0%, transparent 50%)",
                }}
              />

              {/* Ghost number — top left */}
              <span
                className="absolute left-7 top-7 font-display text-[5rem] font-extrabold leading-none select-none lg:text-[6.5rem]"
              ...
              {featured.tag && (
                <span
                  className="absolute right-6 top-6 inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[9px] font-bold uppercase tracking-[0.16em] text-white"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-7 sm:p-9 md:p-10">
                ...
                <h3
                  ...
                  style={{ fontSize: "clamp(1.75rem, 3vw, 2.625rem)", letterSpacing: "-0.04em" }}
                >
                  {featured.title}
                </h3>

                <p
                  className="mt-3 max-w-sm text-[13.5px] leading-[1.75]"
            ...
            {/* Secondary Cards */}
            <div className="grid grid-cols-1 gap-4 md:col-span-2 lg:col-span-2">
              {secondary.map((p) => (
                <article
                  key={p.title}
                  onClick={() => openModal(p)}
                  ...
                  style={{
                    minHeight: "clamp(220px, 22vw, 275px)",
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, #050505 0%, rgba(5,5,5,0.45) 55%, transparent 100%)",
                    }}
                  />

                  {/* Ghost number */}
                  <span
                    className="absolute left-5 top-5 font-display text-[4rem] font-extrabold leading-none select-none sm:text-[4.5rem]"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-7">
                    ...
                    <h3
                      ...
                      style={{ fontSize: "clamp(1.1rem, 2vw, 1.375rem)", letterSpacing: "-0.04em" }}
                    >
                      {p.title}
                    </h3>

                    <p
                      className="mt-1.5 line-clamp-2 text-[12.5px] leading-[1.7]"
                      style={{ color: "rgba(255,255,255,0.38)" }}
                    >
                      {p.description}
                    </p>

                    <span className="btn-text mt-4 text-[10px]">
                      {p.cta}
